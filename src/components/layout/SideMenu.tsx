...
const menuListIcons = [
  ...
  <MenuBook key="menu-book" />,
  <TableRestaurant key="table-restaurant" />,
  <PostAdd key="post-add" />,
  <ReceiptLong key="receipt-long" />,
  <People key="people" />,
  <EditCalendar key="edit-calendar" />,
  <Elderly key="elderly" />,
  <RequestQuote key="request-quote" />,
]
